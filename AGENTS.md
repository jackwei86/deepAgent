...
- 每次修改代码后，不自动将代码推送到github 仓库
- 手动将代码推送到github 仓库时，需要在github 仓库中创建对应的分支，分支名称与代码修改的版本号一致
- 提交代码前先完善版本日志信息，版本日志信息需要包含修改的版本号、修改的内容等

## 版本日志更新说明

- 从基线版本v1.0往后，每次修改代码后，都在更新日志.md中写入对应的版本和更新的日志信息
