...
![版本](https://img.shields.io/badge/版本-v1.1.1-blue) ![基座](https://img.shields.io/badge/基座-Open_WebUI_0.6.43-3b82f6) ![SDK](https://img.shields.io/badge/C++_SDK-1.0.0-green) ![更新日志](https://img.shields.io/badge/更新日志-CHANGELOG.md-grey)
...
- **托盘程序**：双击 `assistant\start_tray.bat`——系统托盘出现 DeepAgent 图标（启动瞬间命令行黑框闪现不到一秒后自动消失，之后无窗口运行），
